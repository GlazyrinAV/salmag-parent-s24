...
public class ClientConfig {
    ...
    @Bean
    public ClientFavoriteProductsClient webClientFavouriteProductsClient(
            @Value("${selmag.service.feedback.uri:http://localhost:8084}") String feedbackBaseUrl,
            WebClient.Builder selmagServicesWebClientBuilder
    ) {
        return new ClientFavoriteProductsClient(selmagServicesWebClientBuilder
                .baseUrl(feedbackBaseUrl)
                .build());
    }

    @Bean
    public ClientProductsReviewClient webClientProductReviewsClient(
            @Value("${selmag.service.feedback.uri:http://localhost:8084}") String feedbackBaseUrl,
            WebClient.Builder selmagServicesWebClientBuilder
    ) {
        return new ClientProductsReviewClient(selmagServicesWebClientBuilder
                .baseUrl(feedbackBaseUrl)
                .build());
    }
